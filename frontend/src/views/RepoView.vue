...
import SetupRepo from '@/components/repo/SetupRepo.vue'
import SubmitRevision from '@/components/repo/SubmitRevision.vue'
import TeamIntegrationGithub from '@/components/repo/TeamIntegrationGithub.vue'
import TeamIntegrationToken from '@/components/repo/TeamIntegrationToken.vue'
